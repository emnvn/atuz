...
--
-- Host: localhost
-- Generation Time: Dec 03, 2013 at 01:28 PM
...
--
-- Database: `hn_solutions`
--

-- --------------------------------------------------------

--
-- Table structure for table `hn_address`
--

CREATE TABLE IF NOT EXISTS `hn_address` (
...
--
-- Dumping data for table `hn_address`
--
...
--
-- Table structure for table `hn_affiliate`
--

CREATE TABLE IF NOT EXISTS `hn_affiliate` (
...
--
-- Dumping data for table `hn_affiliate`
--
...
--
-- Table structure for table `hn_affiliate_transaction`
--

CREATE TABLE IF NOT EXISTS `hn_affiliate_transaction` (
...
--
-- Dumping data for table `hn_affiliate_transaction`
--
...
--
-- Table structure for table `hn_attribute`
--

CREATE TABLE IF NOT EXISTS `hn_attribute` (
...
--
-- Dumping data for table `hn_attribute`
--

INSERT INTO `hn_attribute` (`attribute_id`, `attribute_group_id`, `sort_order`) VALUES
(1, 6, 1),
(2, 6, 5),
(3, 6, 3),
(4, 3, 1),
...
--
-- Table structure for table `hn_attribute_description`
--

CREATE TABLE IF NOT EXISTS `hn_attribute_description` (
...
--
-- Dumping data for table `hn_attribute_description`
--

INSERT INTO `hn_attribute_description` (`attribute_id`, `language_id`, `name`) VALUES
(1, 1, 'Description'),
(2, 1, 'No. of Cores'),
(4, 1, 'test 1'),
(5, 1, 'test 2'),
...
--
-- Table structure for table `hn_attribute_group`
--

CREATE TABLE IF NOT EXISTS `hn_attribute_group` (
...
--
-- Dumping data for table `hn_attribute_group`
--

INSERT INTO `hn_attribute_group` (`attribute_group_id`, `sort_order`) VALUES
(3, 2),
(4, 1),
(5, 3),
(6, 4);
...
--
-- Table structure for table `hn_attribute_group_description`
--

CREATE TABLE IF NOT EXISTS `hn_attribute_group_description` (
  `attribute_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(64) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `hn_attribute_group_description`
--

INSERT INTO `hn_attribute_group_description` (`attribute_group_id`, `language_id`, `name`) VALUES
(3, 1, 'Memory'),
(4, 1, 'Technical'),
(5, 1, 'Motherboard'),
(6, 1, 'Processor');
...
--
-- Table structure for table `hn_banner`
--

CREATE TABLE IF NOT EXISTS `hn_banner` (
...
--
-- Dumping data for table `hn_banner`
--

INSERT INTO `hn_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
(7, 'Samsung Tab', 1),
(8, 'Manufacturers', 1),
(9, 'Nokia', 1),
...
--
-- Table structure for table `hn_banner_image`
--

CREATE TABLE IF NOT EXISTS `hn_banner_image` (
...
--
-- Dumping data for table `hn_banner_image`
--

INSERT INTO `hn_banner_image` (`banner_image_id`, `banner_id`, `link`, `image`) VALUES
...
--
-- Table structure for table `hn_banner_image_description`
--

CREATE TABLE IF NOT EXISTS `hn_banner_image_description` (
...
--
-- Dumping data for table `hn_banner_image_description`
--

INSERT INTO `hn_banner_image_description` (`banner_image_id`, `language_id`, `banner_id`, `title`) VALUES
...
--
-- Table structure for table `hn_category`
--

CREATE TABLE IF NOT EXISTS `hn_category` (
...
--
-- Dumping data for table `hn_category`
--

INSERT INTO `hn_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`, `news_category_id`) VALUES
(71, '', 59, 1, 1, 2, 1, '2013-02-05 22:08:05', '2013-04-12 23:18:35', 0),
...
--
-- Table structure for table `hn_category_description`
--

CREATE TABLE IF NOT EXISTS `hn_category_description` (
...
--
-- Dumping data for table `hn_category_description`
--

INSERT INTO `hn_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`) VALUES
(71, 1, 'Furnitures', '', '', ''),
(60, 1, 'Books', '&lt;p&gt;\r\n	books books books&lt;/p&gt;\r\n', '', ''),
...
--
-- Table structure for table `hn_category_to_layout`
--

CREATE TABLE IF NOT EXISTS `hn_category_to_layout` (
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_category_to_layout`
--
...
--
-- Table structure for table `hn_category_to_store`
--

CREATE TABLE IF NOT EXISTS `hn_category_to_store` (
  `category_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`category_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Dumping data for table `hn_category_to_store`
--

INSERT INTO `hn_category_to_store` (`category_id`, `store_id`) VALUES
(59, 0),
(60, 0),
(61, 0),
(62, 0),
...
--
-- Table structure for table `hn_country`
--

CREATE TABLE IF NOT EXISTS `hn_country` (
...
--
-- Dumping data for table `hn_country`
--

INSERT INTO `hn_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
--
-- Table structure for table `hn_coupon`
--

CREATE TABLE IF NOT EXISTS `hn_coupon` (
...
--
-- Dumping data for table `hn_coupon`
--

INSERT INTO `hn_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `hn_coupon_history`
--

CREATE TABLE IF NOT EXISTS `hn_coupon_history` (
...
--
-- Dumping data for table `hn_coupon_history`
--
...
--
-- Table structure for table `hn_coupon_product`
--

CREATE TABLE IF NOT EXISTS `hn_coupon_product` (
...
--
-- Dumping data for table `hn_coupon_product`
--
...
--
-- Table structure for table `hn_currency`
--

CREATE TABLE IF NOT EXISTS `hn_currency` (
...
--
-- Dumping data for table `hn_currency`
--

INSERT INTO `hn_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Pound Sterling', 'GBP', '£', '', '2', 0.64020002, 1, '2013-08-18 16:51:43'),
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2013-08-18 17:07:43'),
(3, 'Euro', 'EUR', '', '€', '2', 0.75019997, 1, '2013-08-18 16:51:43');

-- --------------------------------------------------------

--
-- Table structure for table `hn_customer`
--

CREATE TABLE IF NOT EXISTS `hn_customer` (
...
--
-- Dumping data for table `hn_customer`
--

INSERT INTO `hn_customer` (`customer_id`, `store_id`, `firstname`, `lastname`, `email`, `telephone`, `fax`, `password`, `salt`, `cart`, `wishlist`, `newsletter`, `address_id`, `customer_group_id`, `ip`, `status`, `approved`, `token`, `date_added`) VALUES
...
--
-- Table structure for table `hn_customer_group`
--

CREATE TABLE IF NOT EXISTS `hn_customer_group` (
...
--
-- Dumping data for table `hn_customer_group`
--

INSERT INTO `hn_customer_group` (`customer_group_id`, `approval`, `company_id_display`, `company_id_required`, `tax_id_display`, `tax_id_required`, `sort_order`) VALUES
(1, 0, 1, 0, 0, 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `hn_customer_group_description`
--

CREATE TABLE IF NOT EXISTS `hn_customer_group_description` (
  `customer_group_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_customer_group_description`
--

INSERT INTO `hn_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');

-- --------------------------------------------------------

--
-- Table structure for table `hn_customer_ip`
--

CREATE TABLE IF NOT EXISTS `hn_customer_ip` (
...
--
-- Dumping data for table `hn_customer_ip`
--

INSERT INTO `hn_customer_ip` (`customer_ip_id`, `customer_id`, `ip`, `date_added`) VALUES
(1, 1, '127.0.0.1', '2013-01-25 23:25:33');

-- --------------------------------------------------------

--
-- Table structure for table `hn_customer_ip_blacklist`
--

CREATE TABLE IF NOT EXISTS `hn_customer_ip_blacklist` (
...
--
-- Dumping data for table `hn_customer_ip_blacklist`
--
...
--
-- Table structure for table `hn_customer_online`
--

CREATE TABLE IF NOT EXISTS `hn_customer_online` (
  `ip` varchar(40) COLLATE utf8_bin NOT NULL,
  `customer_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_customer_online`
--
...
--
-- Table structure for table `hn_customer_reward`
--

CREATE TABLE IF NOT EXISTS `hn_customer_reward` (
...
--
-- Dumping data for table `hn_customer_reward`
--
...
--
-- Table structure for table `hn_customer_transaction`
--

CREATE TABLE IF NOT EXISTS `hn_customer_transaction` (
...
--
-- Dumping data for table `hn_customer_transaction`
--
...
--
-- Table structure for table `hn_download`
--

CREATE TABLE IF NOT EXISTS `hn_download` (
...
--
-- Dumping data for table `hn_download`
--
...
--
-- Table structure for table `hn_download_description`
--

CREATE TABLE IF NOT EXISTS `hn_download_description` (
...
--
-- Dumping data for table `hn_download_description`
--
...
--
-- Table structure for table `hn_extension`
--

CREATE TABLE IF NOT EXISTS `hn_extension` (
...
--
-- Dumping data for table `hn_extension`
--

INSERT INTO `hn_extension` (`extension_id`, `type`, `code`) VALUES
(23, 'payment', 'cod'),
(22, 'total', 'shipping'),
(57, 'total', 'sub_total'),
(58, 'total', 'tax'),
...
--
-- Table structure for table `hn_geo_zone`
--

CREATE TABLE IF NOT EXISTS `hn_geo_zone` (
...
--
-- Dumping data for table `hn_geo_zone`
--

INSERT INTO `hn_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
...
--
-- Table structure for table `hn_information`
--

CREATE TABLE IF NOT EXISTS `hn_information` (
...
--
-- Dumping data for table `hn_information`
--

INSERT INTO `hn_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3, 1, 3, 1),
(4, 1, 1, 1),
(5, 1, 4, 1),
(6, 1, 2, 1),
...
--
-- Table structure for table `hn_information_description`
--

CREATE TABLE IF NOT EXISTS `hn_information_description` (
...
--
-- Dumping data for table `hn_information_description`
--

INSERT INTO `hn_information_description` (`information_id`, `language_id`, `title`, `description`) VALUES
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n'),
...
--
-- Table structure for table `hn_information_to_layout`
--

CREATE TABLE IF NOT EXISTS `hn_information_to_layout` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_information_to_layout`
--

INSERT INTO `hn_information_to_layout` (`information_id`, `store_id`, `layout_id`) VALUES
(7, 0, 2);

-- --------------------------------------------------------

--
-- Table structure for table `hn_information_to_store`
--

CREATE TABLE IF NOT EXISTS `hn_information_to_store` (
  `information_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  PRIMARY KEY (`information_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Dumping data for table `hn_information_to_store`
--

INSERT INTO `hn_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0),
...
--
-- Table structure for table `hn_language`
--

CREATE TABLE IF NOT EXISTS `hn_language` (
...
--
-- Dumping data for table `hn_language`
--

INSERT INTO `hn_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`) VALUES
(1, 'English', 'en', 'en_US.UTF-8,en_US,en-gb,english', 'gb.png', 'english', 'english', 1, 1);

-- --------------------------------------------------------

--
-- Table structure for table `hn_layout`
--

CREATE TABLE IF NOT EXISTS `hn_layout` (
...
--
-- Dumping data for table `hn_layout`
--

INSERT INTO `hn_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
--
-- Table structure for table `hn_layout_route`
--

CREATE TABLE IF NOT EXISTS `hn_layout_route` (
...
--
-- Dumping data for table `hn_layout_route`
--

INSERT INTO `hn_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(30, 6, 0, 'account'),
(17, 10, 0, 'affiliate/'),
...
--
-- Table structure for table `hn_length_class`
--

CREATE TABLE IF NOT EXISTS `hn_length_class` (
...
--
-- Dumping data for table `hn_length_class`
--

INSERT INTO `hn_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
...
--
-- Table structure for table `hn_length_class_description`
--

CREATE TABLE IF NOT EXISTS `hn_length_class_description` (
  `length_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_length_class_description`
--

INSERT INTO `hn_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
...
--
-- Table structure for table `hn_manufacturer`
--

CREATE TABLE IF NOT EXISTS `hn_manufacturer` (
...
--
-- Dumping data for table `hn_manufacturer`
--

INSERT INTO `hn_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `hn_manufacturer_to_store`
--

CREATE TABLE IF NOT EXISTS `hn_manufacturer_to_store` (
...
--
-- Dumping data for table `hn_manufacturer_to_store`
--

INSERT INTO `hn_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
--
-- Table structure for table `hn_news`
--
...
--
-- Dumping data for table `hn_news`
--

INSERT INTO `hn_news` (`news_id`, `status`, `date_available`, `image`, `image_size`, `date_added`) VALUES
(6, 1, NULL, 'data/demo/apple_cinema_30.jpg', 0, '2013-04-15 23:10:05'),
(5, 1, NULL, 'data/demo/apple_logo.jpg', 0, '2013-04-14 22:56:40'),
(7, 1, NULL, 'data/demo/compaq_presario.jpg', 0, '2013-04-15 23:10:55'),
(8, 1, NULL, 'data/demo/hp_logo.jpg', 0, '2013-04-15 23:11:37');

-- --------------------------------------------------------

--
-- Table structure for table `hn_news_category`
--

CREATE TABLE IF NOT EXISTS `hn_news_category` (
  `category_id` int(11) NOT NULL AUTO_INCREMENT,
  `status` int(1) NOT NULL DEFAULT '0',
  `date_added` datetime DEFAULT NULL,
  PRIMARY KEY (`category_id`)
...
--
-- Dumping data for table `hn_news_category`
--

INSERT INTO `hn_news_category` (`category_id`, `status`, `date_added`) VALUES
...
--
-- Table structure for table `hn_news_category_language`
--

CREATE TABLE IF NOT EXISTS `hn_news_category_language` (
...
--
-- Dumping data for table `hn_news_category_language`
--

INSERT INTO `hn_news_category_language` (`id`, `language_id`, `category_id`, `title`, `date_added`) VALUES
...
--
-- Table structure for table `hn_news_description`
--

CREATE TABLE IF NOT EXISTS `hn_news_description` (
...
--
-- Dumping data for table `hn_news_description`
--

INSERT INTO `hn_news_description` (`news_id`, `language_id`, `title`, `meta_description`, `description`) VALUES
(7, 1, '45 Fresh PSD Website Templates 2013 – Photoshop', 'In this article, we have collection fresh and best psd website templates with newest release in 2013 from ThemeForest', '&lt;p&gt;\r\n	In this article, we have collection fresh and best&lt;a href=&quot;http://www.freshdesignweb.com/psd-website-templates-free-download.html&quot; target=&quot;_blank&quot;&gt;&lt;strong&gt; psd website templates&lt;/strong&gt;&lt;/a&gt; with newest release in 2013 from &lt;em&gt;ThemeForest&lt;/em&gt;. All templates was created with modern design responsive and full pages&amp;nbsp;layout support. Before you choose buy those psd files you read software Photoshop requirement that you are currently using because some template require adobe Photoshop CS6, CS5, CS4 or CS3, so you should carefully about this one.&lt;/p&gt;\r\n&lt;p&gt;\r\n	All these premium &lt;strong&gt;psd&lt;/strong&gt; &lt;strong&gt;website templates&lt;/strong&gt; are high quality and professional design that it is very useful and save you lots of time with your design project without reinventing the wheel . So, enjoy this collection and have good luck in creating a website&amp;nbsp; templates your business.&lt;/p&gt;\r\n'),
(8, 1, '40 Best Premium WordPress Themes for Feb 2013', 'Immediately two month of the 2013 has been past actually', '&lt;p&gt;\r\n	Immediately two month of the 2013 has been past actually. During this time, &lt;strong&gt;premium WordPress themes&lt;/strong&gt; have been released and lots of themes are high-quality. In fact, standards of WordPress themes come with high tool and option easy for control, but almost all of them are paid themes.&lt;/p&gt;\r\n&lt;p&gt;\r\n	In this showcase, we are going to show you some best sale &lt;a href=&quot;http://www.freshdesignweb.com/best-sale-premium-responsive-wordpress-themes-2012.html&quot; target=&quot;_blank&quot;&gt;&lt;strong&gt;premium WordPress themes&lt;/strong&gt;&lt;/a&gt; for the second month February 2013 from &lt;em&gt;ThemeForest,&lt;/em&gt; the popular the largest marketplace of its kind for WordPress themes. In face, the templates selling on ThemeForest are cheaper than other websites and those templates can use on commercial or personal site project that it is really good option for everyone.&lt;/p&gt;\r\n'),
(6, 1, 'Minimal WordPress Themes', 'Using a dedicated clean Minimal WordPress Themes will undoubtedly catch the attention of your visitors', '&lt;p&gt;\r\n	Using a dedicated clean &lt;strong&gt;Minimal &lt;a href=&quot;http://www.freshdesignweb.com/best-premium-wordpress-themes-for-february-2013.html&quot; target=&quot;_blank&quot;&gt;WordPress Themes&lt;/a&gt;&lt;/strong&gt; will undoubtedly catch the attention of your visitors because it&amp;nbsp;design style that retains a basic and functional focus, it avoids overly complex designs, instead relying on clean, open space, typography and layout. In this collection we are going to showcase to strengthen your online presence whilst presenting your work in a &lt;a href=&quot;http://www.freshdesignweb.com/clean-minimalistic-web-designs.html&quot; target=&quot;_blank&quot;&gt;minimalistic&lt;/a&gt; and powerful way.&lt;/p&gt;\r\n&lt;p&gt;\r\n	All these premium​ &lt;strong&gt;Minimal WordPress Themes&lt;/strong&gt; are high quality and professional design that it is very useful and save you lots of time with your design project without reinventing the wheel . So, enjoy this collection and have good luck in creating a website&amp;nbsp; templates your business.&lt;/p&gt;\r\n&lt;p&gt;\r\n	You may like this post:&lt;/p&gt;\r\n'),
(5, 1, '20  wordpress  themes', 'A lot of designer do their work by online Freeland', '&lt;p itemprop=&quot;name&quot;&gt;\r\n	A lot of designer do their work by online Freeland. So to show your work achievement you should create your own &lt;a href=&quot;http://www.freshdesignweb.com/best-portfolio-wordpress-themes.html&quot; target=&quot;_blank&quot;&gt;portfolio blog&lt;/a&gt; and it is also make customer easy to find out more about design experience as well. In this post, we have collection premium wordpress themes for designer portfolio to help you easy to find best themes for design portfolio websites. Nowadays, you can easily find Thousand designer of individuals or&amp;nbsp;hire theme to design or develop website for you by just contact from the website.&lt;/p&gt;\r\n&lt;p itemprop=&quot;name&quot;&gt;\r\n	However online designer portfolio come with many different styles and different features, it is a good idea to be design clear themes to set up a WordPress designer portfolio. Many of the themes we selected for this post are &lt;a href=&quot;http://www.freshdesignweb.com/responsive-admin-templates-free-premium.html&quot; target=&quot;_blank&quot;&gt;fully responsive&lt;/a&gt;, so it is perfect website portfolio no matter what device they use.&lt;/p&gt;\r\n&lt;p itemprop=&quot;name&quot;&gt;\r\n	You like this post:&lt;/p&gt;\r\n');

-- --------------------------------------------------------

--
-- Table structure for table `hn_news_to_category`
--

CREATE TABLE IF NOT EXISTS `hn_news_to_category` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `hn_news_to_category`
--

INSERT INTO `hn_news_to_category` (`id`, `category_id`, `news_id`) VALUES
(30, 2, 5),
(29, 1, 5),
(32, 2, 6),
(31, 1, 6),
...
--
-- Table structure for table `hn_news_to_store`
--

CREATE TABLE IF NOT EXISTS `hn_news_to_store` (
...
--
-- Dumping data for table `hn_news_to_store`
--

INSERT INTO `hn_news_to_store` (`news_id`, `store_id`) VALUES
(1, 0),
(2, 0),
(5, 0),
(6, 0),
...
--
-- Table structure for table `hn_option`
--

CREATE TABLE IF NOT EXISTS `hn_option` (
...
--
-- Dumping data for table `hn_option`
--

INSERT INTO `hn_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 2),
(2, 'checkbox', 3),
(4, 'text', 4),
(5, 'select', 1),
...
--
-- Table structure for table `hn_option_description`
--

CREATE TABLE IF NOT EXISTS `hn_option_description` (
...
--
-- Dumping data for table `hn_option_description`
--

INSERT INTO `hn_option_description` (`option_id`, `language_id`, `name`) VALUES
(1, 1, 'Radio'),
(2, 1, 'Checkbox'),
(4, 1, 'Text'),
(6, 1, 'Textarea'),
...
--
-- Table structure for table `hn_option_value`
--

CREATE TABLE IF NOT EXISTS `hn_option_value` (
...
--
-- Dumping data for table `hn_option_value`
--

INSERT INTO `hn_option_value` (`option_value_id`, `option_id`, `image`, `sort_order`) VALUES
(43, 1, '', 3),
(32, 1, '', 1),
(45, 2, '', 4),
(44, 2, '', 3),
...
--
-- Table structure for table `hn_option_value_description`
--

CREATE TABLE IF NOT EXISTS `hn_option_value_description` (
...
--
-- Dumping data for table `hn_option_value_description`
--

INSERT INTO `hn_option_value_description` (`option_value_id`, `language_id`, `option_id`, `name`) VALUES
(43, 1, 1, 'Large'),
(32, 1, 1, 'Small'),
(45, 1, 2, 'Checkbox 4'),
(44, 1, 2, 'Checkbox 3'),
...
--
-- Table structure for table `hn_order`
--

CREATE TABLE IF NOT EXISTS `hn_order` (
...
--
-- Dumping data for table `hn_order`
--
...
--
-- Table structure for table `hn_order_download`
--

CREATE TABLE IF NOT EXISTS `hn_order_download` (
...
--
-- Dumping data for table `hn_order_download`
--
...
--
-- Table structure for table `hn_order_fraud`
--

CREATE TABLE IF NOT EXISTS `hn_order_fraud` (
  `order_id` int(11) NOT NULL,
  `customer_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_order_fraud`
--
...
--
-- Table structure for table `hn_order_history`
--

CREATE TABLE IF NOT EXISTS `hn_order_history` (
...
--
-- Dumping data for table `hn_order_history`
--
...
--
-- Table structure for table `hn_order_option`
--

CREATE TABLE IF NOT EXISTS `hn_order_option` (
...
--
-- Dumping data for table `hn_order_option`
--
...
--
-- Table structure for table `hn_order_product`
--

CREATE TABLE IF NOT EXISTS `hn_order_product` (
...
--
-- Dumping data for table `hn_order_product`
--
...
--
-- Table structure for table `hn_order_status`
--

CREATE TABLE IF NOT EXISTS `hn_order_status` (
...
--
-- Dumping data for table `hn_order_status`
--

INSERT INTO `hn_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(7, 1, 'Canceled'),
(5, 1, 'Complete'),
...
--
-- Table structure for table `hn_order_total`
--

CREATE TABLE IF NOT EXISTS `hn_order_total` (
...
--
-- Dumping data for table `hn_order_total`
--
...
--
-- Table structure for table `hn_order_voucher`
--

CREATE TABLE IF NOT EXISTS `hn_order_voucher` (
...
--
-- Dumping data for table `hn_order_voucher`
--
...
--
-- Table structure for table `hn_product`
--
...
--
-- Dumping data for table `hn_product`
--

INSERT INTO `hn_product` (`product_id`, `model`, `sku`, `upc`, `ean`, `jan`, `isbn`, `mpn`, `location`, `quantity`, `stock_status_id`, `image`, `manufacturer_id`, `shipping`, `price`, `points`, `tax_class_id`, `date_available`, `weight`, `weight_class_id`, `length`, `width`, `height`, `length_class_id`, `subtract`, `minimum`, `sort_order`, `status`, `date_added`, `date_modified`, `viewed`) VALUES
...
(126, 'FurnitureThemeHomeDecor', '', '', '', '', '', '', '', 100, 5, 'data/webtemplates/FurnitureStoreTheme/FurnitureThemeHomeDecorPage01.jpg', 0, 1, '89.0000', 0, 0, '2013-03-03', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2013-03-04 23:11:14', '0000-00-00 00:00:00', 19),
(127, 'FurnitureThemeHomeDecor2', '', '', '', '', '', '', '', 100, 5, 'data/webtemplates/FurnitureStoreTheme/FurnitureThemeHomeDecor2Page03.jpg', 0, 1, '89.0000', 0, 0, '2013-03-04', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2013-03-05 21:43:06', '0000-00-00 00:00:00', 14),
...
(130, 'NatureThemeFlower01', '', '', '', '', '', '', '', 100, 5, 'data/webtemplates/NatureTheme/NatureThemeFlowerPage01.jpg', 0, 1, '99.0000', 0, 0, '2013-03-04', '0.00000000', 1, '0.00000000', '0.00000000', '0.00000000', 1, 1, 1, 1, 1, '2013-03-05 22:08:47', '0000-00-00 00:00:00', 2),
...
--
-- Table structure for table `hn_product_attribute`
--

CREATE TABLE IF NOT EXISTS `hn_product_attribute` (
  `product_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_product_attribute`
--
...
--
-- Table structure for table `hn_product_description`
--

CREATE TABLE IF NOT EXISTS `hn_product_description` (
  `product_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_bin NOT NULL,
  `description` text COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `hn_product_description`
--

INSERT INTO `hn_product_description` (`product_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `tag`) VALUES
...
--
-- Table structure for table `hn_product_discount`
--

CREATE TABLE IF NOT EXISTS `hn_product_discount` (
...
--
-- Dumping data for table `hn_product_discount`
--
...
--
-- Table structure for table `hn_product_image`
--

CREATE TABLE IF NOT EXISTS `hn_product_image` (
...
--
-- Dumping data for table `hn_product_image`
--

INSERT INTO `hn_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Table structure for table `hn_product_option`
--

CREATE TABLE IF NOT EXISTS `hn_product_option` (
...
--
-- Dumping data for table `hn_product_option`
--
...
--
-- Table structure for table `hn_product_option_value`
--

CREATE TABLE IF NOT EXISTS `hn_product_option_value` (
...
--
-- Dumping data for table `hn_product_option_value`
--
...
--
-- Table structure for table `hn_product_related`
--

CREATE TABLE IF NOT EXISTS `hn_product_related` (
  `product_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_product_related`
--

INSERT INTO `hn_product_related` (`product_id`, `related_id`) VALUES
(51, 75),
(62, 75),
(70, 75),
(72, 75),
...
--
-- Table structure for table `hn_product_reward`
--

CREATE TABLE IF NOT EXISTS `hn_product_reward` (
...
--
-- Dumping data for table `hn_product_reward`
--

INSERT INTO `hn_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(579, 77, 1, 0),
(578, 76, 1, 0),
(692, 75, 1, 0),
(576, 74, 1, 0),
...
--
-- Table structure for table `hn_product_special`
--

CREATE TABLE IF NOT EXISTS `hn_product_special` (
...
--
-- Dumping data for table `hn_product_special`
--
...
--
-- Table structure for table `hn_product_to_category`
--

CREATE TABLE IF NOT EXISTS `hn_product_to_category` (
  `product_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_product_to_category`
--

INSERT INTO `hn_product_to_category` (`product_id`, `category_id`) VALUES
(50, 60),
(51, 60),
(52, 60),
(53, 60),
...
--
-- Table structure for table `hn_product_to_download`
--

CREATE TABLE IF NOT EXISTS `hn_product_to_download` (
  `product_id` int(11) NOT NULL,
  `download_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_product_to_download`
--
...
--
-- Table structure for table `hn_product_to_layout`
--

CREATE TABLE IF NOT EXISTS `hn_product_to_layout` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL,
...
--
-- Dumping data for table `hn_product_to_layout`
--
...
--
-- Table structure for table `hn_product_to_store`
--

CREATE TABLE IF NOT EXISTS `hn_product_to_store` (
  `product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`product_id`,`store_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
--
-- Dumping data for table `hn_product_to_store`
--

INSERT INTO `hn_product_to_store` (`product_id`, `store_id`) VALUES
(50, 0),
(51, 0),
(52, 0),
(53, 0),
...
--
-- Table structure for table `hn_return`
--

CREATE TABLE IF NOT EXISTS `hn_return` (
...
--
-- Dumping data for table `hn_return`
--
...
--
-- Table structure for table `hn_return_action`
--

CREATE TABLE IF NOT EXISTS `hn_return_action` (
...
--
-- Dumping data for table `hn_return_action`
--

INSERT INTO `hn_return_action` (`return_action_id`, `language_id`, `name`) VALUES
(1, 1, 'Refunded'),
(2, 1, 'Credit Issued'),
...
--
-- Table structure for table `hn_return_history`
--

CREATE TABLE IF NOT EXISTS `hn_return_history` (
...
--
-- Dumping data for table `hn_return_history`
--
...
--
-- Table structure for table `hn_return_reason`
--

CREATE TABLE IF NOT EXISTS `hn_return_reason` (
...
--
-- Dumping data for table `hn_return_reason`
--

INSERT INTO `hn_return_reason` (`return_reason_id`, `language_id`, `name`) VALUES
(1, 1, 'Dead On Arrival'),
...
--
-- Table structure for table `hn_return_status`
--

CREATE TABLE IF NOT EXISTS `hn_return_status` (
...
--
-- Dumping data for table `hn_return_status`
--

INSERT INTO `hn_return_status` (`return_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(3, 1, 'Complete'),
...
--
-- Table structure for table `hn_review`
--

CREATE TABLE IF NOT EXISTS `hn_review` (
...
--
-- Dumping data for table `hn_review`
--
...
--
-- Table structure for table `hn_setting`
--

CREATE TABLE IF NOT EXISTS `hn_setting` (
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE=utf8_bin AUTO_INCREMENT=2653 ;

--
-- Dumping data for table `hn_setting`
--

INSERT INTO `hn_setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`) VALUES
...
(2546, 0, 'config', 'config_google_analytics', '', 0),
(2545, 0, 'config', 'config_error_filename', 'error.txt', 0),
(2544, 0, 'config', 'config_error_log', '1', 0),
(27, 0, 'coupon', 'coupon_sort_order', '4', 0),
(28, 0, 'coupon', 'coupon_status', '1', 0),
(2543, 0, 'config', 'config_error_display', '1', 0),
(2542, 0, 'config', 'config_compression', '0', 0),
(34, 0, 'flat', 'flat_sort_order', '1', 0),
(35, 0, 'flat', 'flat_status', '1', 0),
(36, 0, 'flat', 'flat_geo_zone_id', '0', 0),
(37, 0, 'flat', 'flat_tax_class_id', '9', 0),
(2549, 0, 'carousel', 'carousel_module', 'a:1:{i:0;a:9:{s:9:"banner_id";s:2:"11";s:5:"limit";s:1:"5";s:6:"scroll";s:1:"3";s:5:"width";s:3:"130";s:6:"height";s:2:"32";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"3";}}', 1),
(41, 0, 'flat', 'flat_cost', '5.00', 0),
(42, 0, 'credit', 'credit_sort_order', '7', 0),
(43, 0, 'credit', 'credit_status', '1', 0),
(2541, 0, 'config', 'config_encryption', '7666e897bc2de392cde584fa7b8a891d', 0),
(2540, 0, 'config', 'config_maintenance', '0', 0),
(2539, 0, 'config', 'config_seo_url', '0', 0),
(2538, 0, 'config', 'config_use_ssl', '0', 0),
(2537, 0, 'config', 'config_fraud_status_id', '7', 0),
(2536, 0, 'config', 'config_fraud_score', '', 0),
(2535, 0, 'config', 'config_fraud_key', '', 0),
(53, 0, 'reward', 'reward_sort_order', '2', 0),
(54, 0, 'reward', 'reward_status', '1', 0),
(2534, 0, 'config', 'config_fraud_detection', '0', 0),
...
(2558, 0, 'category_tabs', 'category_tabs_module', 'a:1:{i:0;a:5:{s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:5:"count";s:1:"1";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"4";}}', 1),
(2533, 0, 'config', 'config_alert_emails', '', 0),
(2530, 0, 'config', 'config_smtp_timeout', '5', 0),
...
(2532, 0, 'config', 'config_account_mail', '0', 0),
(2531, 0, 'config', 'config_alert_mail', '0', 0),
(2526, 0, 'config', 'config_smtp_host', 'smtp.googlemail.com', 0),
(2527, 0, 'config', 'config_smtp_username', 'ippbx.dtsc@gmail.com', 0),
(2528, 0, 'config', 'config_smtp_password', 'dtsc2013', 0),
(2529, 0, 'config', 'config_smtp_port', '587', 0),
(2525, 0, 'config', 'config_mail_parameter', '', 0),
(2524, 0, 'config', 'config_mail_protocol', 'smtp', 0),
(2523, 0, 'config', 'config_image_cart_height', '47', 0),
(2519, 0, 'config', 'config_image_compare_height', '90', 0),
(2520, 0, 'config', 'config_image_wishlist_width', '47', 0),
(2522, 0, 'config', 'config_image_cart_width', '47', 0),
(2521, 0, 'config', 'config_image_wishlist_height', '47', 0),
(2518, 0, 'config', 'config_image_compare_width', '90', 0),
(2517, 0, 'config', 'config_image_related_height', '80', 0),
(2516, 0, 'config', 'config_image_related_width', '80', 0),
(2515, 0, 'config', 'config_image_additional_height', '74', 0),
(2514, 0, 'config', 'config_image_additional_width', '74', 0),
(2513, 0, 'config', 'config_image_product_height', '80', 0),
(2512, 0, 'config', 'config_image_product_width', '80', 0),
(93, 0, 'voucher', 'voucher_sort_order', '8', 0),
(94, 0, 'voucher', 'voucher_status', '1', 0),
(2511, 0, 'config', 'config_image_popup_height', '500', 0),
(2510, 0, 'config', 'config_image_popup_width', '500', 0),
(2509, 0, 'config', 'config_image_thumb_height', '228', 0),
(2507, 0, 'config', 'config_image_category_height', '80', 0),
(102, 0, 'free_checkout', 'free_checkout_status', '1', 0),
(103, 0, 'free_checkout', 'free_checkout_order_status_id', '1', 0),
(2508, 0, 'config', 'config_image_thumb_width', '228', 0),
(2506, 0, 'config', 'config_image_category_width', '80', 0),
(2505, 0, 'config', 'config_icon', 'data/cart.png', 0),
(2503, 0, 'config', 'config_cart_weight', '1', 0),
(2504, 0, 'config', 'config_logo', 'data/logo_03.png', 0),
(2502, 0, 'config', 'config_upload_allowed', 'jpg, JPG, jpeg, gif, png, txt', 0),
(2501, 0, 'config', 'config_download', '1', 0),
(2500, 0, 'config', 'config_review_status', '1', 0),
(2499, 0, 'config', 'config_return_status_id', '2', 0),
(2498, 0, 'config', 'config_complete_status_id', '5', 0),
(2497, 0, 'config', 'config_order_status_id', '1', 0),
(2496, 0, 'config', 'config_stock_status_id', '5', 0),
(2495, 0, 'config', 'config_stock_checkout', '0', 0),
(2494, 0, 'config', 'config_stock_warning', '0', 0),
(2493, 0, 'config', 'config_stock_display', '0', 0),
(2492, 0, 'config', 'config_commission', '5', 0),
(2491, 0, 'config', 'config_affiliate_id', '4', 0),
(2490, 0, 'config', 'config_checkout_id', '5', 0),
(2489, 0, 'config', 'config_account_id', '3', 0),
(2488, 0, 'config', 'config_guest_checkout', '1', 0),
(2487, 0, 'config', 'config_customer_approval', '0', 0),
(2486, 0, 'config', 'config_customer_price', '0', 0),
(2485, 0, 'config', 'config_customer_group_id', '1', 0),
(2484, 0, 'config', 'config_order_edit', '100', 0),
(2483, 0, 'config', 'config_invoice_prefix', 'INV-2012-00', 0),
(2482, 0, 'config', 'config_tax_customer', 'shipping', 0),
(2480, 0, 'config', 'config_tax', '1', 0),
(2481, 0, 'config', 'config_tax_default', 'shipping', 0),
(2479, 0, 'config', 'config_admin_limit', '20', 0),
(2478, 0, 'config', 'config_catalog_limit', '15', 0),
...
(2473, 0, 'config', 'config_admin_language', 'en', 0),
(2472, 0, 'config', 'config_language', 'en', 0),
(2471, 0, 'config', 'config_country_id', '222', 0),
(2470, 0, 'config', 'config_layout_id', '4', 0),
(2469, 0, 'config', 'config_template', 'modern', 0),
(2468, 0, 'config', 'config_meta_description', 'My Store', 0),
(2467, 0, 'config', 'config_title', 'Your Store', 0),
(2465, 0, 'config', 'config_telephone', '123456789', 0),
(2466, 0, 'config', 'config_fax', '', 0),
(2464, 0, 'config', 'config_email', 'nghiaem@gmail.com', 0),
(2463, 0, 'config', 'config_address', 'Address 1', 0),
(2462, 0, 'config', 'config_owner', 'Your Name', 0),
(2461, 0, 'config', 'config_name', 'Your Store', 0),
(2645, 0, 'news', 'news_module', 'a:1:{i:0;a:7:{s:5:"limit";s:1:"5";s:9:"layout_id";s:2:"12";s:8:"position";s:11:"content_top";s:6:"status";s:1:"1";s:8:"headline";s:1:"0";s:8:"numchars";s:2:"60";s:10:"sort_order";s:1:"1";}}', 1),
(2460, 0, 'slideshow', 'slideshow_module', 'a:2:{i:0;a:7:{s:9:"banner_id";s:1:"7";s:5:"width";s:3:"740";s:6:"height";s:3:"280";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"0";s:10:"sort_order";s:1:"1";}i:1;a:7:{s:9:"banner_id";s:1:"9";s:5:"width";s:3:"718";s:6:"height";s:3:"348";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"1";}}', 1),
(2644, 0, 'news', 'news_headline_module', '1', 0),
(2643, 0, 'news', 'news_popup_height', '600', 0),
(2642, 0, 'news', 'news_popup_width', '400', 0),
(2641, 0, 'news', 'news_thumb_height', '64', 0),
(2640, 0, 'news', 'news_thumb_width', '64', 0),
...
(2580, 0, 'featured', 'featured_module', 'a:3:{i:0;a:7:{s:5:"limit";s:2:"10";s:11:"image_width";s:2:"80";s:12:"image_height";s:2:"80";s:9:"layout_id";s:1:"1";s:8:"position";s:14:"content_bottom";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"2";}i:1;a:7:{s:5:"limit";s:1:"2";s:11:"image_width";s:2:"80";s:12:"image_height";s:2:"80";s:9:"layout_id";s:1:"2";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"2";}i:2;a:7:{s:5:"limit";s:1:"2";s:11:"image_width";s:2:"80";s:12:"image_height";s:2:"80";s:9:"layout_id";s:1:"3";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"2";}}', 1),
(2584, 0, 'banner', 'banner_module', 'a:4:{i:1;a:7:{s:9:"banner_id";s:2:"10";s:5:"width";s:3:"250";s:6:"height";s:3:"362";s:9:"layout_id";s:1:"1";s:8:"position";s:11:"content_top";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"2";}i:2;a:7:{s:9:"banner_id";s:2:"12";s:5:"width";s:3:"976";s:6:"height";s:3:"159";s:9:"layout_id";s:1:"1";s:8:"position";s:14:"content_bottom";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"1";}i:3;a:7:{s:9:"banner_id";s:2:"10";s:5:"width";s:3:"143";s:6:"height";s:3:"211";s:9:"layout_id";s:1:"2";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"4";}i:4;a:7:{s:9:"banner_id";s:2:"10";s:5:"width";s:3:"143";s:6:"height";s:3:"211";s:9:"layout_id";s:1:"3";s:8:"position";s:11:"column_left";s:6:"status";s:1:"1";s:10:"sort_order";s:1:"4";}}', 1),
(2578, 0, 'featured', 'product', '', 0),
(2579, 0, 'featured', 'featured_product', '130,55,77,97,135,141,149,110,108', 0),
...
(2639, 0, 'news', 'news_headline_chars', '30', 0),
...
--
-- Table structure for table `hn_stock_status`
--

CREATE TABLE IF NOT EXISTS `hn_stock_status` (
...
--
-- Dumping data for table `hn_stock_status`
--

INSERT INTO `hn_stock_status` (`stock_status_id`, `language_id`, `name`) VALUES
(7, 1, 'In Stock'),
(8, 1, 'Pre-Order'),
(5, 1, 'Out Of Stock'),
(6, 1, '2 - 3 Days');
...
--
-- Table structure for table `hn_store`
--

CREATE TABLE IF NOT EXISTS `hn_store` (
...
--
-- Dumping data for table `hn_store`
--
...
--
-- Table structure for table `hn_tax_class`
--

CREATE TABLE IF NOT EXISTS `hn_tax_class` (
...
--
-- Dumping data for table `hn_tax_class`
--

INSERT INTO `hn_tax_class` (`tax_class_id`, `title`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `hn_tax_rate`
--

CREATE TABLE IF NOT EXISTS `hn_tax_rate` (
...
--
-- Dumping data for table `hn_tax_rate`
--

INSERT INTO `hn_tax_rate` (`tax_rate_id`, `geo_zone_id`, `name`, `rate`, `type`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `hn_tax_rate_to_customer_group`
--

CREATE TABLE IF NOT EXISTS `hn_tax_rate_to_customer_group` (
...
--
-- Dumping data for table `hn_tax_rate_to_customer_group`
--

INSERT INTO `hn_tax_rate_to_customer_group` (`tax_rate_id`, `customer_group_id`) VALUES
(86, 1),
(87, 1);
...
--
-- Table structure for table `hn_tax_rule`
--

CREATE TABLE IF NOT EXISTS `hn_tax_rule` (
...
--
-- Dumping data for table `hn_tax_rule`
--

INSERT INTO `hn_tax_rule` (`tax_rule_id`, `tax_class_id`, `tax_rate_id`, `based`, `priority`) VALUES
(121, 10, 86, 'payment', 1),
(120, 10, 87, 'store', 0),
(128, 9, 86, 'shipping', 1),
(127, 9, 87, 'shipping', 2);
...
--
-- Table structure for table `hn_url_alias`
--

CREATE TABLE IF NOT EXISTS `hn_url_alias` (
...
--
-- Dumping data for table `hn_url_alias`
--

INSERT INTO `hn_url_alias` (`url_alias_id`, `query`, `keyword`) VALUES
(730, 'manufacturer_id=8', 'apple'),
(772, 'information_id=4', 'about_us'),
(798, 'news_id=5', 'news, tin tuc'),
...
INSERT INTO `hn_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `code`, `ip`, `status`, `date_added`) VALUES
(1, 1, 'admin', '4f8752fa936452988f0fcf01944ee16b3f705f93', '4d82153ce', '', '', 'nghiaem@gmail.com', '', '127.0.0.1', 1, '2012-11-30 22:52:12');

-- --------------------------------------------------------

--
-- Table structure for table `hn_user_group`
--

CREATE TABLE IF NOT EXISTS `hn_user_group` (
...
--
-- Dumping data for table `hn_voucher`
--
...
--
-- Table structure for table `hn_voucher_history`
--

CREATE TABLE IF NOT EXISTS `hn_voucher_history` (
...
--
-- Dumping data for table `hn_voucher_history`
--
...
--
-- Table structure for table `hn_voucher_theme`
--

CREATE TABLE IF NOT EXISTS `hn_voucher_theme` (
...
--
-- Dumping data for table `hn_voucher_theme`
--

INSERT INTO `hn_voucher_theme` (`voucher_theme_id`, `image`) VALUES
...
--
-- Table structure for table `hn_voucher_theme_description`
--

CREATE TABLE IF NOT EXISTS `hn_voucher_theme_description` (
  `voucher_theme_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `hn_voucher_theme_description`
--

INSERT INTO `hn_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`) VALUES
(6, 1, 'Christmas'),
(7, 1, 'Birthday'),
(8, 1, 'General');
...
--
-- Table structure for table `hn_weight_class`
--

CREATE TABLE IF NOT EXISTS `hn_weight_class` (
...
--
-- Dumping data for table `hn_weight_class`
--

INSERT INTO `hn_weight_class` (`weight_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '1000.00000000'),
(5, '2.20460000'),
(6, '35.27400000');
...
--
-- Table structure for table `hn_weight_class_description`
--

CREATE TABLE IF NOT EXISTS `hn_weight_class_description` (
  `weight_class_id` int(11) NOT NULL AUTO_INCREMENT,
  `language_id` int(11) NOT NULL,
  `title` varchar(32) COLLATE utf8_bin NOT NULL,
...
--
-- Dumping data for table `hn_weight_class_description`
--

INSERT INTO `hn_weight_class_description` (`weight_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Kilogram', 'kg'),
(2, 1, 'Gram', 'g'),
(5, 1, 'Pound ', 'lb'),
(6, 1, 'Ounce', 'oz');
...
--
-- Table structure for table `hn_zone`
--

CREATE TABLE IF NOT EXISTS `hn_zone` (
...
--
-- Dumping data for table `hn_zone`
--

INSERT INTO `hn_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
--
-- Table structure for table `hn_zone_to_geo_zone`
--

CREATE TABLE IF NOT EXISTS `hn_zone_to_geo_zone` (
...
--
-- Dumping data for table `hn_zone_to_geo_zone`
--

INSERT INTO `hn_zone_to_geo_zone` (`zone_to_geo_zone_id`, `country_id`, `zone_id`, `geo_zone_id`, `date_added`, `date_modified`) VALUES
